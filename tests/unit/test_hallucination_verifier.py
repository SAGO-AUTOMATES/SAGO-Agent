...
class TestResponseVerifier:
    ...
    def test_clean_response_no_issues(self) -> None:
        ...
        result = verifier.verify(
            ...
            tool_history=[
                {"tool": "read_file", "args": {"file_path": "test.py"}, "result": "content"}
            ],
        )
    ...
    def test_sanitize_content(self) -> None:
        ...
        verifier = ResponseVerifier(
            enable_external_checks=False, auto_sanitize=True, confidence_threshold=100
        )
        result = verifier.verify(
    ...
    def test_all_issues_combined(self) -> None:
        ...
        assert (
            result.all_issues
            == result.issues + result.code_issues + result.claim_issues + result.external_issues
        )
