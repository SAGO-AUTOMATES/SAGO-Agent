...
flowchart TD
    ...
    Swarm --> Tools["🛠️ Tool Matrix (74 Safe / Risk-Gated Tools)"]
...
Agents interact with the environment via **74 production tools** registered under `sago/tools/`. Every tool execution is evaluated by the **Permission Manager** ([`sago/permissions.py`](file:///mnt/ramdisk/sago/sago/permissions.py)):
