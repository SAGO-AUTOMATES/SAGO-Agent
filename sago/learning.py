...
class LearningStore:
    ...
    def _load(self) -> dict[str, Any]:
        if self._path.exists():
            try:
                ...
                pass
        return {
            "successful_patterns": {},  # task_type -> list of successful approaches
            "failed_patterns": {},      # task_type -> list of failure reasons
            "tool_effectiveness": {},   # tool_name -> success rate
            "language_patterns": {},    # language -> common project structures
            "error_fixes": {},          # error_message -> successful fix
        }
    ...
    def get_successful_approaches(self, task_type: str) -> list[dict]:
        ...
        return self._data["successful_patterns"].get(task_type, [])
    ...
    def get_language_patterns(self, language: str) -> list[dict]:
        ...
        return self._data["language_patterns"].get(language, [])
    ...
    def suggest_approach(self, task_type: str, available_tools: list[str]) -> str | None:
        ...
        if not successes:
            return None
        # Find the most recent success that uses tools we have
