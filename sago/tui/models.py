...
COMMANDS = {
    ...
    "/shortcuts": "Keyboard shortcuts & cheatsheet modal",
    ...
    "/agents": "List specialist agents (/agents [category])",
    ...
    "/plan": "Show/edit orchestration plan (/plan [edit|add|remove])",
    ...
    "/handoff": "Show current handoff/recursion state",
    ...
    "/project_graph": "Project knowledge graph view",
    "/map": "Repository AST symbol map (/map [query])",
    "/verify": "Run multi-language linters, type checks, and tests",
    "/search": "Hybrid semantic + symbol search (/search <query>)",
    "/git": "Git operations (/git [status|diff|commit|log])",
    "/diff": "Inspect workspace file diffs (/diff [file])",
    "/commit": "Commit staged changes (/commit <message>)",
    "/pr": "Pull-request workflow helper (/pr [create|status])",
    ...
    "/permissions": "Manage tool permissions (alias of /perms)",
    "/allow": "Allow a tool (/allow <tool>)",
    "/block": "Block a tool (/block <tool>)",
    ...
    "/deny": "Deny pending tool action",
    "/ask": "Ask user a clarifying question",
    "/changes": "Show tracked file changes",
    "/summary": "Toggle exit summary display",
    "/detach": "Detach session without exiting",
    "/clean": "Clean caches and temp files (/clean [gc])",
    "/gc": "Run garbage collection cleanup",
    "/copy": "Copy last response to clipboard (/copy [code|all])",
    "/clip": "Clipboard alias of /copy",
}
