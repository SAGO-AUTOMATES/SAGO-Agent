...
class TaskDelegator:
    ...
    TASK_KEYWORDS: dict[TaskType, list[str]] = {
        TaskType.CODE_WRITE: [
            ...
            "function", "class", "module", "feature", "api", "endpoint",
        ],
        TaskType.CODE_REVIEW: [
            "review", "check", "audit", "evaluate", "assess", "improve",
            "refactor", "optimize", "clean", "quality",
        ],
        TaskType.DEBUG: [
            "debug", "fix", "error", "bug", "issue", "problem", "crash",
            "exception", "trace", "stack", "log", "fail", "broken",
        ],
        TaskType.ARCHITECTURE: [
            "architect", "design", "plan", "structure", "scale", "system",
            "pattern", "microservice", "database", "schema", "migration",
        ],
        TaskType.DEVOPS: [
            "deploy", "docker", "kubernetes", "ci/cd", "pipeline", "terraform",
            "aws", "gcp", "azure", "cloud", "infrastructure", "container",
        ],
        TaskType.SECURITY: [
            "security", "vulnerability", "auth", "encrypt", "ssl", "tls",
            "permission", "access", "owasp", "pentest", "audit",
        ],
        TaskType.DATA: [
            "data", "sql", "query", "database", "etl", "pipeline", "analytics",
            "migration", "transform", "extract", "load",
        ],
        TaskType.DOCUMENTATION: [
            "document", "readme", "docs", "api docs", "comment", "explain",
            "tutorial", "guide", "write",
        ],
        TaskType.TESTING: [
            "test", "unit test", "integration", "e2e", "coverage", "mock",
            "assert", "pytest", "jest", "playwright",
        ],
        TaskType.DEPLOYMENT: [
            "deploy", "release", "ship", "production", "rollback", "monitor",
            "sre", "incident", "oncall",
        ],
        TaskType.RESEARCH: [
            "research", "investigate", "compare", "evaluate", "analyze",
            "study", "explore", "find", "search",
        ],
    }
    ...
    AGENT_MAP: dict[TaskType, list[str]] = {
        TaskType.CODE_WRITE: [
            "python-engineer", "full-stack-engineer", "go-engineer",
            "rust-engineer", "typescript-engineer", "java-engineer",
        ],
        TaskType.CODE_REVIEW: [
            "code-reviewer", "reviewer", "security-reviewer",
        ],
        TaskType.DEBUG: [
            "debugger", "security-engineer", "incident-response-engineer",
        ],
        TaskType.ARCHITECTURE: [
            "solutions-architect", "enterprise-architect", "domain-architect",
            "system-architect", "data-architect",
        ],
        TaskType.DEVOPS: [
            "devops", "kubernetes-engineer", "docker-engineer",
            "terraform-engineer", "aws-engineer", "gcp-engineer",
        ],
        TaskType.SECURITY: [
            "security-engineer", "appsec-engineer", "devsecops-engineer",
            "cloud-security-engineer", "k8s-security-engineer",
        ],
        TaskType.DATA: [
            "data-engineer", "data-architect", "database-administrator",
            "ml-engineer", "analytics-engineer",
        ],
        TaskType.DOCUMENTATION: [
            "technical-writer", "api-documentation-engineer",
            "documentation-updater",
        ],
        TaskType.TESTING: [
            "qa-engineer", "tester", "penetration-tester",
            "performance-engineer", "e2e-automation-engineer",
        ],
        TaskType.DEPLOYMENT: [
            "site-reliability-engineer", "release-engineer",
            "devops", "platform-engineer",
        ],
        TaskType.RESEARCH: [
            "researcher", "business-analyst", "data-analyst",
        ],
        TaskType.GENERAL: [
    ...
    COMPLEXITY_INDICATORS: dict[TaskComplexity, list[str]] = {
        ...
        TaskComplexity.COMPLEX: [
            ...
            "architecture", "scale", "distributed",
        ],
        TaskComplexity.EXPERT: [
            "security", "performance", "critical", "production", "enterprise",
            "compliance", "audit", "disaster recovery",
        ],
    }
    ...
    def _select_agents(
        self, task_type: TaskType, task: str
    ) -> tuple[str, list[str]]:
